...
import LINE-TCR
from LINE-TCR.lib.curve.ttypes import *
...
cl = LINE-TCR.LINE()
cl.login(token="EqPgxDO6gXLE7rcLmxX9.TnGPW4QBZeVXjFVsPbzXgq.+WXcEMdfyC5ZUKaFzujO3iHOrr9F7abTAKkndiavj0c=")
cl.loginResult()
...
Bots=["ub4d829c38a9bcc4bf125fbd2a4167119"]
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["anu Lagi Off Kalau Penting Pc Aja",cName + " tag mulu jones?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Rasita Nya lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
...
#==============================================================================#
                ...
                cl.sendText(msg.to,"Powered By TēāmBøtÅđhï [T-B-A]")
...
#======================================================================#
                    ...
                    wait["Sider"] == True
                    cl.sendText(msg.to,"Cek yang ngintip on..!!!")

            elif msg.text in ["Intip off","intip off"]:
                    if msg.to in cctv['point']:
                        cctv['cyduk'][msg.to]=False
                        wait["Sider"] = False
                        cl.sendText(msg.to,"Cek yang ngintip off")
                    else:
...
#                future = datetime(2018,04,31)
#                days = (str(future - today))
#                comma = days.find(",")
#                days = days[:comma]
#                cl.sendText(msg.to,"「About 」\n 「TeamAdhiBot」sᴇʟғʙᴏᴛ By Adhi \n\n「Subscription」\n Expired: " + "\n In days: " + days +  "\n\n「Contact」\n・ LINE me")
#                msg.contentType = 13
#                msg.contentMetadata = {'mid':mid}
#                cl.sendMessage(msg)
#==============================================================================#
